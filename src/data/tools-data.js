...
const tools = [
...

  {
    ...
    plans: [
      { name: 'Core', priceMonthly: 25, priceYearly: 20, limit: '$20–25/mo in credits (matches plan price), consumed per-checkpoint under effort-based pricing. Up to 5 collaborators, 2 parallel agents.', target: 'Solo builders, small teams', notes: '' },
      { name: 'Pro', priceMonthly: 100, priceYearly: 95, limit: '$100/mo in credits, unused rolls over one month. Up to 15 collaborators, 10 parallel agents, “Turbo Mode.”', target: 'Teams and power users', notes: "Replaced the old 'Teams' plan in Feb 2026." },
